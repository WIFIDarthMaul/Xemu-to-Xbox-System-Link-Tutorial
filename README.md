...
![](https://drive.google.com/file/d/1TEPqEKoQCubmTg6U6nS2qfOf5MuqWGjG/view?usp=sharing)
...
NOTE:
If the if there are updates, or dlc that the Xbox has and Xemu doesn’t, or vice versa, it won’t work. Each has to be on the same version and have the same dlc. Either download, or delete them to fix it.
